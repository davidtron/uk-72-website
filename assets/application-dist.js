...
})( jQuery, window );/* Mobile Menu jQuery Plugin
 *
...
function(){b.fn.matchHeight._apply(this.elements,this.byRow)});e=-1},b.fn.matchHeight._throttle))};b(b.fn.matchHeight._applyDataApi);b(window).bind("load resize orientationchange",b.fn.matchHeight._update);var k=function(a){var d=null,c=[];b(a).each(function(){var a=b(this),e=a.offset().top-g(a.css("margin-top")),h=0<c.length?c[c.length-1]:null;null===h?c.push(a):1>=Math.floor(Math.abs(d-e))?c[c.length-1]=h.add(a):c.push(a);d=e});return c},g=function(a){return parseFloat(a)||0}})(jQuery);var Utils;

Utils = (function() {
  function Utils() {}

  Utils.prototype.setAsActiveBtn = function(elem) {
    return $(elem).parent('li').addClass('active');
  };
  ...
  Utils.prototype.redirectTo = function(path) {
    return window.location = path;
  };

  Utils.prototype.isOldInternetExplorer = function() {
...
this.Sf72 = (function() {
  ...
  Sf72.Utils = new Utils;

  return Sf72;

})();window.showActive = function(elements) {
  var activeElem, inactiveElems, urlHash;
  urlHash = window.location.hash || elements[0].href;
  activeElem = _(elements).find(function(elem) {
    return elem.href === urlHash;
  });
  if (activeElem) {
    ...
    return _(inactiveElems).each(function(inactiveElem) {
      ...
      return $(inactiveElem.anchorSelector).parent('li').removeClass('active');
    });
  }
};window.twitterShare = function(text) {
  if (text) {
    return window.open("http://twitter.com/share?text=" + text + ":", '', 'width=600,height=300');
  } else {
    return window.open("http://twitter.com/share?text=Let’s%20get%20connected.+Let’s%20get%20prepared.:", '', 'width=600,height=300');
  }
};
...
window.makeCorsRequest = function(url, successCallback, jsonParams, method) {
  var params, xhr;
  if (jsonParams == null) {
    jsonParams = {};
  }
  ...
  params = "";
  _(_(jsonParams).keys()).each(function(k, index) {
    if (index === _(jsonParams).keys().length - 1) {
      return params += k + "=" + jsonParams[k];
    } else {
      return params += k + "=" + jsonParams[k] + "&";
    }
  });
...
Header = (function() {
  var _initializeActiveButton, _initializeMobileActiveBtn, _initializeMobileMenu, initilized;
  ...
  _initializeActiveButton = function() {
    var hash, paths, windowPath;
    ...
    if (windowPath === '/home' || windowPath === '/') {
      ...
      return window.Sf72.Utils.setAsActiveBtn($('[href="/home"]'));
    } else {
      return _(paths).each(function(path) {
        if (path === windowPath) {
          window.Sf72.Utils.setAsActiveBtn($('[href="' + path + '"]'));
          window.Sf72.Utils.setAsActiveBtn($('[href="' + path + hash + '"]'));
          if ($('[href="' + path + '"]').closest('.submenu')) {
            return $('[href="' + path + '"]').closest('ul.submenu');
          }
        }
      });
    }
  ...
  _initializeMobileActiveBtn = function() {
    var js_buttons_li;
    js_buttons_li = $('li.em-li');
    return js_buttons_li.children('a').click(function() {
      $('#build-menu-overlay').trigger('click');
      js_buttons_li.each(function(i, e) {
        return $(e).removeClass('active');
      });
      return window.Sf72.Utils.setAsActiveBtn($(this));
    });
  };
...
this.Sf72.Header = new Header(this.Sf72);var RetinaResponsive;

RetinaResponsive = (function() {
  var checkRetinaDisplay, isRetinaDisplay;

  function RetinaResponsive() {}

  isRetinaDisplay = function() {
    return window.devicePixelRatio && window.devicePixelRatio > 1;
  };

  checkRetinaDisplay = function() {
    var images;
    if (isRetinaDisplay()) {
      ...
      $.each(images, function(i, e) {
        ...
        return $(e).attr('src', retina_url);
      });
      return true;
    }
  };

  RetinaResponsive.prototype.check = function() {
    return checkRetinaDisplay();
  };

  return RetinaResponsive;

})();

this.Sf72.RetinaResponsive = new RetinaResponsive;var app;

app = this.Sf72;

jQuery(function(app) {
  Sf72.Header.init();
  return Sf72.RetinaResponsive.check();
});// Modified from https://github.com/city72/city-72
// This is a manifest file that'll be compiled into application.js, which will include all the files
// listed below.
//
// Any JavaScript/Coffee file within assets/javascripts or assets/components,
